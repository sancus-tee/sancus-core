...
proc print_help {} {
  variable script_file
  puts "\nDescription:"
  puts "This script will open the project and program the generated bitstream"
  puts "to the first connected FPGA.\n"
  puts "Syntax:"
  puts "$script_file"
...
# Set current device
set obj [lindex [get_hw_devices xc7z020_1] 0]
current_hw_device $obj
refresh_hw_device -update_hw_probes false $obj
