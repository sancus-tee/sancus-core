MEMORY {
  ...
  ram (wx)         : ORIGIN = 0x0200, LENGTH = 0x4000 /* END=0x0300, size 256 */
  ...
  //rom (rx)         : ORIGIN = 0xf000, LENGTH = 0x0fe0 /* END=0xffe0, size 4064 */
  rom (rx)         : ORIGIN = 0xa000, LENGTH = 0x6000-0x20 /* END=0xffe0, size 4064 */
