 ...
 * you are granted a perpetual, irrevocable license to copy, modify and distribute it as you see fit.
 * 
 * That being said, I would appreciate credit! If you find Loguru useful, 
 * tweet me at @ernerfeldt mail me at emil.ernerfeldt@gmail.com.
 * Taken from https://github.com/emilk/loguru
 * */
...
#define VTSEQ(ID) ("\x1b[" #ID "m")
	...
	static void print_preamble_header(char* out_buff, size_t out_buff_size)
	{
        ...
        // Sancus hack: Add nice simulator message to header
        pos += snprintf(out_buff + pos, out_buff_size, "======================= Sancus Simulator =======================");
	}
